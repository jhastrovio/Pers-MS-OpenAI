...
class MSGraphClient:
    ...
    async def fetch_drive_items(self, user_email: str, folder_path: str = "", download: bool = False, recursive: bool = True) -> List[Dict]:
        ...
        params = {
            "$select": "id,name,size,file,folder,parentReference,webUrl,lastModifiedDateTime,createdBy,lastModifiedBy",
    ...
    async def get_onedrive_files(self, user_email: str, top=10):
        """
