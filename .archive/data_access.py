        ...
        for email in emails:
            ...
            entry = DataEntry(
                ...
                metadata={
                    ...
                    "key_info": key_info,
                    "sentiment": sentiment,
                    "url": f"https://outlook.office.com/mail/id/{email.id}"
                }
            )
        ...
        for file in files:
            ...
            entry = DataEntry(
                ...
                metadata={
                    ...
                    "size": file.size,
                    "author": getattr(file, "created_by", ""),
                    "last_modified_by": getattr(file, "last_modified_by", ""),
                    "date": file.last_modified.isoformat() if hasattr(file, "last_modified") else None,
                    "path": getattr(file, "path", None),
                    "summary": summary,
                    "key_info": key_info,
                    "url": getattr(file, "web_url", "")
                }
            )
            entries.append(entry)
